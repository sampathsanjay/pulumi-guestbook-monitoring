...
function getComponentOutputs(componentDefinition, resource) {
    const result = {};
...
class ComponentProvider {
    ...
    async getSchema() {
        ...
        const schema = schema_1.generateSchema(this.name, this.version, this.packageJSON.description, components, typeDefinitions, dependencies, this.namespace);
