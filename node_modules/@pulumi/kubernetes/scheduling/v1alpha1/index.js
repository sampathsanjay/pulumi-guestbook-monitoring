...
exports.WorkloadPatch = exports.WorkloadList = exports.Workload = exports.PriorityClassPatch = exports.PriorityClassList = exports.PriorityClass = void 0;
    ...
    construct: (name, type, urn) => {
        switch (type) {
            ...
            case "kubernetes:scheduling.k8s.io/v1alpha1:WorkloadList":
                return new exports.WorkloadList(name, undefined, { urn });
            case "kubernetes:scheduling.k8s.io/v1alpha1:WorkloadPatch":
                return new exports.WorkloadPatch(name, undefined, { urn });
            default:
